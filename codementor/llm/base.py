...
if TYPE_CHECKING:
    from codementor.llm.providers.openai import OpenAIFunctionCall
...
class ChatSequence:
    ...
    def for_model(cls, model_name: str, messages: list[Message] | ChatSequence = []):
        from codementor.llm.providers.openai import OPEN_AI_CHAT_MODELS
    ...
    def token_length(self):
        from codementor.llm.utils import count_message_tokens
